...
$sql = "SELECT * FROM system WHERE department = 'Cashier' ORDER BY id ASC";
...
<body>
    ...
    <div class="header">
            ...
            <h3 class="assessment_title">DWCL cashier</h3>
        </div>
    <!-- Columns -->
    ...
    function handleNextButton(section, nextButtonId, action) {
        ...
        nextButton.addEventListener("click", function () {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "../function/cashier.php", true);
    ...
    <script>
        function refreshQueueSection() {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "../function/refresh_cashier.php", true);
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
