...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["action"])) {
    if ($_POST["action"] == "updateQueue") {
        ...
        $sqlSelect = "SELECT * FROM system WHERE `department` = 'Cashier' AND `status` = 'Queue' ORDER BY id ASC";
        ...
        $sqlSelect = "SELECT * FROM system WHERE `department` = 'Cashier' AND status = 'Current' ORDER BY id ASC";
        $resultSelect = mysqli_query($conn, $sqlSelect);
        ...
        // Retrieve the lowest ID record from the "Current" section
        $sqlSelect = "SELECT * FROM system WHERE `department` = 'Cashier' AND status = 'Pending' ORDER BY id ASC";
        $resultSelect = mysqli_query($conn, $sqlSelect);
        ...
        // Retrieve the lowest ID record from the "Current" section
        $sqlSelect = "SELECT * FROM system WHERE `department` = 'Cashier' AND status = 'Current' ORDER BY id DESC";
        $resultSelect = mysqli_query($conn, $sqlSelect);
